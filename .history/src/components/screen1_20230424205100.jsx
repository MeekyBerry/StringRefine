...
const Screen1 = ({ inputValue, handleInputChanges }) => {
  ...
  // Return the JSX for the Screen1 component
  return (
    <div className="screenOne">
      ...
      <div className="screenOne__container">
        <input
          type="text"
          value={inputValue} // Bind the inputValue state variable to the value of the input field
          onChange={handleInputChange} // Call the handleInputChange function when the input field value changes
